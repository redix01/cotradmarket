 ...
 <div class="px-4 pt-5">
    ...
    <ul class="flex text-sm font-medium text-center text-gray-500 rounded-lg shadow sm:flex dark:divide-gray-700 dark:text-gray-400">
        <li class="w-full focus-within:z-10">
            <a href="{{ route('admin.openTrades') }}"  class="inline-block w-full p-4 bg-white border-r border-gray-200 dark:border-gray-700 hover:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700">Open Trades</a>
        </li>
        <li class="w-full focus-within:z-10">
            <a href="{{ route('admin.closedTrades') }}"  class="inline-block w-full p-4 text-gray-900 bg-gray-100 border-r border-gray-200 dark:border-gray-700 rounded-s-lg focus:ring-4 focus:ring-blue-300 active focus:outline-none dark:bg-gray-700 dark:text-white" aria-current="page">Closed Trades</a>
        </li>
    </ul>
              ...
              <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                  <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr class="d-flex ">
                        ...
                        <th scope="col" class="p-4 text-xs font-medium tracking-wider text-left text-gray-500 uppercase dark:text-white">Profit/Loss</th>
                    ...
                    @foreach($trades as $item)
                        @if($item->status == 'closed')
                            <tr>
                                ...
                                <td class="p-4 text-sm font-semibold text-gray-900 whitespace-nowrap dark:text-white">${!! number_format($item->profit_loss, 2) ?? '' !!}</td>
