                  ...
                  <tr>
                    ...
                    <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                      ...
                      <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                        <img class="w-10 h-10 rounded-full" style="border-radius: 50%"  height="50" width="50" src="{{ asset($item->user->avatar ?? '/img/trader.jpg') }}" alt="Neil Sims avatar">
                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                            <div class="text-base font-semibold text-gray-900 dark:text-white">{{ $item->user->name ?? '' }}</div>
                        </div>
                    </td>
                        ...
                        <div class="relative w-full h-full max-w-md px-4 md:h-auto">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                ...
                                <div class="p-6 pt-0 text-center">
                                    ...
                                    <!-- Delete form -->
                                    <form id="deleteForm" action="{{ route('admin.deleteCopiedTrade', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <!-- Modal body -->
                                 <div class="p-4 md:p-5 space-y-4">
                                  <form class="" action="{{ route('admin.fundCopiedTrade', $item->id) }}" method="POST"  enctype="multipart/form-data">
                                    @csrf

                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        <div class="col-span-2">
                                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Profit/Loss</label>
                                            <input type="number" step="0.001" name="amount" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                   placeholder="Trader Name"  value="{{ old('profit_loss', $item->profit_loss ?? '') }}">
                                             <small class="text-white">Enter the profit/loss (-10) for this copied trade </small>
                                        </div>
